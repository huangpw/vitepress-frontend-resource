module.exports = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Node.js', link: '/javascript/node/' },
      { text: 'Axios.js', link: '/javascript/axios/' },
      { text: 'Alova.js', link: '/javascript/alova/' },
      { text: 'Three.js', link: '/javascript/three/' },
      { text: '微前端', link: '/javascript/micro-frontend/' },
      { text: '其他库', link: '/javascript/other/' },
    ],
  },
  {
    text: '🍃Vue',
